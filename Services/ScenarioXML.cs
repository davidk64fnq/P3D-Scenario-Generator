...
namespace P3D_Scenario_Generator.Services
{
    public class ScenarioXML
    {
        ...
        public static void SetSimbaseDocumentXML(ScenarioFormData formData, Overview overview)
        {
			...
			simBaseDocumentXML.Descr = $"This is a {formData.ScenarioImageFolder} scenario generated by {Constants.appTitle}. Estimated time to complete: {ScenarioHTML.GetDuration(overview)} minutes.";
			simBaseDocumentXML.Title = $"{overview.Title}";
        ...
        public static void SetCircuitWorldBaseFlightXML(ScenarioFormData formData, Overview overview, MakeCircuit makeCircuit)
        {
			...
			// First pass
			for (int gateNo = 1; gateNo < makeCircuit.GatesCount - 1; gateNo++)
            {
            ...
            for (int gateNo = 1; gateNo < makeCircuit.GatesCount - 1; gateNo++)
            {
                ...
                if (gateNo + 1 < makeCircuit.GatesCount - 1)
                {
        ...
        static private async Task SetMovingMapJS(int count, ScenarioFormData formData, FileOps fileOps, FormProgressReporter progressReporter)
        {
            ...
            using (StreamReader reader = new(stream))
            {
                ...
                await fileOps.TryWriteAllTextAsync(saveLocation, movingMapJS, progressReporter);
            }
        }
