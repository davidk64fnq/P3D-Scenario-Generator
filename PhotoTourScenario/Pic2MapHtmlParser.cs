...
namespace P3D_Scenario_Generator.PhotoTourScenario
{
    ...
    /// </remarks>
    /// <param name="log">The logging service used to report errors.</param>
    ...
    internal class Pic2MapHtmlParser(ILogger log, IHtmlParser htmlParser, IHttpRoutines httpRoutines) : IPic2MapHtmlParser
    {
        private readonly ILogger _log = log;
        private readonly IHtmlParser _htmlParser = htmlParser;
        // Add a field for the HttpRoutines instance
