...
namespace P3D_Scenario_Generator
{
    public class ScenarioXML
    {
		...
		static private void SetSimbaseDocumentXML()
        {
			...
			simBaseDocumentXML.Descr = $"This is a {Parameters.SelectedScenario} scenario generated by {Con.appTitle}. Estimated time to complete: {ScenarioHTML.GetDuration()} minutes.";
        ...
        static private void SetCircuitWorldBaseFlightXML()
        {
			...
			for (int gateNo = 1; gateNo < Circuit.gates.Count - 1; gateNo++)
            {
				...
				string hwp = GetGateWorldPosition(Circuit.GetGate(gateNo), Con.hoopActVertOffset);
                string nwp = GetGateWorldPosition(Circuit.GetGate(gateNo), Con.numBlueVertOffset);
