...
namespace P3D_Scenario_Generator
{
    public class ScenarioXML
    {
		...
		static private void SetSimbaseDocumentXML()
        {
			...
			simBaseDocumentXML.Descr = $"This is a {Parameters.SelectedScenarioType} scenario generated by {Constants.appTitle}. Estimated time to complete: {ScenarioHTML.GetDuration()} minutes.";
        ...
        static private void SetCircuitWorldBaseFlightXML()
        {
        ...
        static private void SetSignWritingWorldBaseFlightXML()
        {
            SetDisabledTrafficAirports($"{Runway.startRwy.IcaoId}");
            SetRealismOverrides();
            SetScenarioMetadata();
        ...
        static private void SetScenarioMetadata()
        {
            SimMissionUIScenarioMetadata md = new()
            {
                ...
                SuccessMessage = $"Success! You completed the \"{Parameters.SelectedScenarioType}\" scenario objectives.",
                FailureMessage = $"Better luck next time! You failed to complete the \"{Parameters.SelectedScenarioType}\" scenario objectives.",
                UserCrashMessage = $"Yikes! You crashed and therefore failed the \"{Parameters.SelectedScenarioType}\" scenario objectives."
            };
        ...
        static private void SetSignWritingCSS()
        {
        ...
        static private void SetSignWritingHTML()
        {
        ...
        static private void SetSignWritingJS()
        {
