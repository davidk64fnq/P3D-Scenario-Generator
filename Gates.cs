namespace P3D_Scenario_Generator
{
    ...
    internal class Gates
    {
        ...
        internal static void SetCircuitGates()
        {
            ...
            double turnCircumference = Parameters.Speed * Constants.feetInKnot * 2 / 60;
            ...
            switch (Parameters.SelectedScenario)
            {
                case nameof(ScenarioTypes.Circuit):
                    ...
                    legParams.Add(new LegParams((Runway.Hdg + Runway.MagVar - 45 + 360) % 360, turnRadius, Runway.Altitude + Parameters.HeightUpwind + gate1to2heightDif));
                    ...
                    legParams.Add(new LegParams((Runway.Hdg + Runway.MagVar - 135 + 360) % 360, turnRadius, Runway.Altitude + Parameters.HeightDown));
                    ...
                    legParams.Add(new LegParams((Runway.Hdg + Runway.MagVar - 225 + 360) % 360, turnRadius, Runway.Altitude + Parameters.HeightDown));
                    ...
                    legParams.Add(new LegParams((Runway.Hdg + Runway.MagVar - 315 + 360) % 360, turnRadius, Runway.Altitude + Parameters.HeightBase));
                    break;
                default:
                    break;
            }
