...
// See C:\Program Files\Lockheed Martin\Prepar3D v5 SDK 5.4.9.28482\World\Autogeneration\SimPropSymbols\propmission.xml (and propbuilder.xml) for reference
...
public class SimMissionScriptAction(string? descr = null, string? script = null, string? id = null)
{
    public SimMissionScriptAction() : this(null, null, null) { }
    [XmlElement("Descr")] public string? Descr { get; set; } = descr;
...
public class SimMissionScenarioVariable(List<TriggerCondition>? conditions = null, string? id = null, string? descr = null, string? name = null, string? val = null)
{
    public SimMissionScenarioVariable() : this(null, null, null, null, null) { }
...
public class SetWindowLocation(int x = 0, int y = 0)
{
    ...
    [XmlElement("LocationX")] public int LocationX { get; set; } = x;
    [XmlElement("LocationY")] public int LocationY { get; set; } = y;
}

[XmlRoot("SetWindowSize")]
public class SetWindowSize(int width = 0, int height = 0)
{
    public SetWindowSize() : this(0, 0) { }
    [XmlElement("WindowWidth")] public int WindowWidth { get; set; } = width;
    [XmlElement("WindowHeight")] public int WindowHeight { get; set; } = height;
}
